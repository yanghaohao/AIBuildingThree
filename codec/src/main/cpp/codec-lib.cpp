...
Java_com_zgw_company_base_utils_EncryptUtils_encryptPayPassword(JNIEnv *env, jobject,
                                                              jstring old_string) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_zgw_company_base_utils_EncryptUtils_encryptPayPasswordWithSalt(JNIEnv *env, jobject,
                                                                      jstring old_string,
                                                                      jint type) {
...
jstring Java_com_zgw_company_base_utils_EncryptUtils_nativeCheck(JNIEnv *env, jobject) {
