...
class Settings(prefs: SharedPreferences = MyApplication.instance.getSharedPreferences(SP_KEY_DEFAULT, preferenceMode)) {
...
//    var countryAbbreviation by prefs.string(SP_COUNTRY_ABBREVIATION, isEncrypt = true)
    ...
    companion object {
        ...
        fun create(context: Context = MyApplication.instance): Settings {
