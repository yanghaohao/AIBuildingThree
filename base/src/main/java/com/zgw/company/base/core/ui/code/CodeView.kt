package com.zgw.company.base.core.ui.code
...
class CodeView : View {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        //宽度-左右边宽-中间分割线宽度
        unitWidth =
            (width - 2 * borderWidth - (length - 1) * dividerWidth - (length - 1) * padding) / length
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        if (attrs == null) {
            ...
            borderColor =
                typedArray.getColor(R.styleable.CodeView_borderColor, Color.parseColor("#E1E1E1"))
            borderSelectColor = typedArray.getColor(
                R.styleable.CodeView_borderSelectColor,
                Color.parseColor("#9666FB")
            )
            borderWidth =
                typedArray.getDimensionPixelSize(R.styleable.CodeView_borderWidth, 1).toFloat()
            dividerColor =
                typedArray.getColor(R.styleable.CodeView_dividerColor, Color.parseColor("#E1E1E1"))
            dividerWidth =
                typedArray.getDimensionPixelSize(R.styleable.CodeView_dividerWidth, 1).toFloat()
            code = typedArray.getString(R.styleable.CodeView_code)
            if (code == null) {
                code = ""
            }
            codeColor =
                typedArray.getColor(R.styleable.CodeView_codeColor, Color.parseColor("#000000"))
            pointRadius = typedArray.getDimensionPixelSize(
                R.styleable.CodeView_pointRadius,
                dp2px(context, 8f)
            ).toFloat()
        ...
        if (dividerWidth > 0) {
            ...
            for (i in 0 until length) {
                if (i == 0) {
                    ...
                    canvas.drawRect(
                        i * unitWidth + padding * i + borderWidth * i,
                        0f,
                        (i + 1) * unitWidth + padding * i + borderWidth * i,
                        unitWidth,
                        paint!!
                    )
                }
