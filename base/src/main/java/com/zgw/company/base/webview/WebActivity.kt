...
import com.zgw.company.base.core.domain.request.TokenRequestParams
import com.zgw.company.base.core.utils.LanguageUtil
...
class WebActivity : BaseActivity() {
    ...
    private fun initData() {
        ...
        model.tokenParams.value =
            intent?.getSerializableExtra(INJECTED_TOKEN_PARAMS) as TokenRequestParams?

        //自有域名默认添加android接口。
        if (mUrl != null) {
            mUrl = URLParser(mUrl).addParam(LANGUAGE_COUNTRY, LanguageUtil.getHttpLanguageHeader())
                .toString()
    ...
    companion object {
        ...
        fun launch(
            ...
            url: String?,
            title: String? = null,
            injectedName: String? = null,
            skipInterceptor: Boolean = true,
            tokenParams: TokenRequestParams? = null
        ) {
