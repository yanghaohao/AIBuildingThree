...
import com.zgw.company.base.core.ui.progress.CircleProgressView
import com.zgw.company.base.core.ui.progress.GlideImageLoader
import com.zgw.company.base.core.dsl.setOnPageChangeListener
...
class ImagePicsListActivity : BaseActivity() {
    ...
    private val mOnPhotoTapListener = OnViewTapListener { view, _, _ ->
    ...
    private inner class MyPagerAdapter(var context: Context, private val mUrls: ArrayList<String>?) : PagerAdapter() {
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            ...
            val requestBuilder = imageLoader.requestBuilder(url, requestOptions).transition(
