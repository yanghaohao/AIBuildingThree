...
import com.zgw.company.base.core.ui.LoadingInterface
import java.util.ArrayList

class MultiStatusView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : RelativeLayout(context, attrs, defStyleAttr),
 LoadingInterface {


 //    private List<View> childViews;
 private val mOtherIds = ArrayList<Int>()
 private val defaultLayoutParams = RelativeLayout.LayoutParams(
 ...
 companion object {
  ...
  private const val TAG = "com.zgw.company.base.core.ui.widget.MultiStatusView"
  /**
   * The empty state
   */
